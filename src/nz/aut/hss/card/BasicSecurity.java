...
public class Security extends BasicService
	...
	public Security() {
		...
		resetSecuritySettings();
	       ...
	       keypair = new KeyPair(KeyPair.ALG_EC_F2M, (short)KeyBuilder.LENGTH_AES_128;
	       keypair.genKeyPair();
	       PublicKey publickey = keypair.getPublic();
	       PrivateKey privatekey = keypair.getPrivate();

//~~~how to get other users public key bytes
	       byte[] otherPublicKeyBytes = ...get public key bytes;
	       KeyAgreement ka = KeyAgreement.getInstance(KeyAgreement.ALG_EC_SVDP_DH, false);
	       ka.init(privatekey);
	       ka.generateSecret(otherPublicKeyBytes, (short)0, (short)otherPublicKeyBytes.length, keyBytes, (short)0);
